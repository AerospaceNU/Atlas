...
def _default_data_dir() -> Path:
    ...
    return root / "local" / "models" / "segment_landcover" / "train"
...
def fit_centroids(data_dir: Path) -> dict[str, list[float]]:
    """Average native-resolution mean RGB per class subdirectory of ``data_dir``."""
...
def main(argv: list[str] | None = None) -> None:
    ...
    centroids = fit_centroids(data_dir)
