...
class EsaWorldCoverClient(PlanetaryComputerClient):
    ...
    include_datetime: ClassVar[bool] = False
    satellite: ClassVar[str] = "worldcover"
    scene_kind: ClassVar[SceneKind] = SceneKind.landcover
